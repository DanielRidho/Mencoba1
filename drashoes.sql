...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 18 Jun 2024 pada 10.22
...
(8, 'Daniel', 'radikal@gmail.com', 'barbatos', 'admin');
...
(1, 'Deep Clean', 35000, '../img/deep.jpg'),
...
--
ALTER TABLE `pricelist`
  MODIFY `id_pricelist` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
